    ...
    subDests: [
      {
        ...
        driveTimeHours: 1.0,
        driveKm: 60,
        highlights: ['Mornington Main Street cafes and boutiques', 'Mills Beach and pier walk', 'Mornington Racecourse Market (Wednesdays)', 'Easy day trips to Red Hill wineries'],
        themes: ['Beach', 'Food', 'Relaxation', 'Markets'],
