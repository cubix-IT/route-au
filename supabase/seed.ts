...
const SUB_DESTINATIONS = [
  ...
  { id:'healesville-wildlife', cluster_id:'dandenongs', name:'Healesville (Wildlife)', drive_time_hours:1.0, drive_km:65, lat:-37.654, lng:145.520, themes:['Wildlife','Family','Nature'], highlights:['Healesville Sanctuary — platypus, dingo, koala','Maroondah Reservoir Park','Rainforest Gallery at the sanctuary','Steels Creek picnic areas'], display_order:4 },
